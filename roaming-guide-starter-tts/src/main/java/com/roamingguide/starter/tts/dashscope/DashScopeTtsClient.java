package com.roamingguide.starter.tts.dashscope;

import com.alibaba.dashscope.audio.ttsv2.SpeechSynthesisAudioFormat;
import com.alibaba.dashscope.audio.ttsv2.SpeechSynthesisParam;
import com.alibaba.dashscope.audio.ttsv2.SpeechSynthesizer;
import com.roamingguide.starter.tts.TtsClient;
import com.roamingguide.starter.tts.TtsProperties;
import com.roamingguide.starter.tts.TtsRequest;
import com.roamingguide.starter.tts.TtsResponse;
...
public class DashScopeTtsClient implements TtsClient {
    ...
    public TtsResponse synthesize(TtsRequest request) {
        try {
            String voice = request.getVoice() != null ? request.getVoice() : ttsProperties.getDefaultVoice();
            String model = request.getModel() != null ? request.getModel() : ttsProperties.getModel();
            ...
            if (audioBuffer == null || audioBuffer.remaining() == 0) {
                ...
                return TtsResponse.failure("TTS返回音频数据为空");
            }
            ...
            return TtsResponse.success(audioBytes, format);

        } catch (Exception e) {
            log.error("DashScope TTS合成失败", e);
            return TtsResponse.failure("DashScope TTS合成失败: " + e.getMessage());
        }
    }
